...
By: CIPHER (Claude Code AI Assistant)
For: RECTOR
...
👉 **[Full gh CLI Guide: GH_CLI_GUIDE.md](GH_CLI_GUIDE.md)**
...
**Purpose:** Step-by-step instructions for applying all changes
**When to use:** When you're ready to implement the revamp
**Time needed:** 5 hours (can split into sessions)

---

### 2. profile/README.md
**Purpose:** Organization homepage content (displayed at github.com/RECTOR-LABS)
**How to use:**
...
**Purpose:** Universal template for creating consistent READMEs
**When to use:** When adding new repos or updating remaining 6 repos
**Features:**
...
**Purpose:** All repository descriptions + GitHub topics + bio options
**Contents:**
...
**Purpose:** Custom README for CORE (Rails 8 flagship)
**Length:** ~450 lines of markdown excellence
**Features:**
...
**Purpose:** Custom README for MEVRebels Protocol
**Length:** ~400 lines
**Features:**
...
**Purpose:** Custom README for Web3 Deal Discovery (NFT Coupons)
**Length:** ~350 lines
**Features:**
...
**Purpose:** Custom README for OpenBudget ID (Civic Tech)
**Length:** ~350 lines
**Features:**
...
**Purpose:** Custom README for ASI Agents Track (Multi-Agent AI)
**Length:** ~380 lines
**Features:**
...
**Purpose:** Custom README for recMEV Installer (Infrastructure Tool)
**Length:** ~350 lines
**Features:**
